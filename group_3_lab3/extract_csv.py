...
# denote which columns will be extracted from the original csv file, as listed in the header
...
with (open('./data/raw/20222023.csv', 'r', newline = '', encoding = 'utf-8') as infile,
    ...
    # print previously denoted columns (see line 4) from original file to new one
    for row in reader:
